    ...
    if(!profileExists) {
        return (
            <Paper className={classes.paper} elevation={6} >
                ...
                <MuiChipsInput className={classes.addMargin} name="tags" variant="outlined" label="Tags" disabled fullWidth value={postData.tags} onAddChip={(chip) => handleAddChip(chip)} onDeleteChip={(chip) => handleDeleteChip(chip)} />
    ...
    return (
        <Paper className={classes.paper}>
            <form autoComplete='off' noValidate className={`${classes.root} ${classes.form}`} onSubmit={handleSubmit}>
                ...
                <MuiChipsInput color='secondary' className={classes.addMargin} name="tags" variant="outlined" label="Tags" fullWidth value={postData.tags} onAddChip={(chip) => handleAddChip(chip)} onDeleteChip={(chip) => handleDeleteChip(chip)} />
